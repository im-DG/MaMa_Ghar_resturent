...
const About = () => {
    ...
    return (
        <Layout>
            <Banner />
            <section className="w-full h-[100vh] py-8 flex flex-col items-center bg-[#e0e9ddaa]">
                ...
                <div className="relative overflow-y-scroll w-[100%] sm:w-[90%] md:w-[80%] max-w-[100%] h-[60rem] rounded-md shadow-sm shadow-black">
                    <div className="absolute  right-[25%] sm:right-[35%] top-[9 rem] sm:top-[18rem] max-w-[20%] border shadow-xl shadow-gray-500 rounded-full flex justify-center items-center ">
                        <img
                    ...
                    <div className="sm:flex justify-between h-[100vh] max-w-[100%]">
                        <div className="flex flex-col justify-center items-center sm:w-[50%] w-[100%] h-full bg-[#62809280] rounded-l-md">
                            <h1 className="flex flex-col mt-4 w-[50%]">
                                <span className="uppercase text-blue-800 text-sm sm:text-xl font-bold my-2">
                                    testy
                                </span>
                                <span className="uppercase text-cyan-700 text-sm sm:text-3xl font-bold my-2">
                                    delicious
                                </span>
                                <span className="uppercase text-green-800 text-sm sm:text-xl font-bold my-2">
                                    yummy
                                </span>
                            </h1>
                            <p className="max-w-[50%] max-h-[100%] text-sm sm:text-[1.2rem] text-gray-500">
                        ...
                        <div className=" flex justify-center sm:justify-end items-center sm:w-[50%] w-[100%] max-h-[100%] bg-[#cdcacdaa] rounded-r-md p-2 md:p-5">
